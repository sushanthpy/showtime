...
$(".closeButton").hoverSprite({onLoadWebSite: false});
...
///////////////////////////////////////////////
   ...
   // $('.menu > ul >li').eq(0).css({'display':'none'});
	var content=$('#content'),
		...
		,actFu:function(_){			
			if(_.curr){
				_.curr.css({'display':'block', height:'0px', top:'0px'}).stop().delay(400).animate({height:"940px"},600,'easeOutCubic');
